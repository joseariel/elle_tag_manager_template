...

{
  ...
  "description": "This tag will add Elle\u0027s Intelligent Text Messaging to your site by configuring HTML IDs/classes where Elle should be triggered.\nThe tag either includes a Segment analytics script to the website.",
  "containerContexts": [
    "WEB"
  ]
}
